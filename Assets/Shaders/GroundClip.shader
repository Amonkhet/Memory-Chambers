Shader "Moebius/FlatColorWithNormalDetail_GroundClip"
{
    Properties
    {
        ...
        // clip ground
        _GroundHeight("Ground Height (Y)", Float) = 0.0
    }
    ...
    SubShader
    {
        ...
        Pass
        {
            ...
            half4 Frag(Varyings IN) : SV_Target
            {
                ...
                clip(IN.positionWS.y - _GroundHeight);
        ...
        Pass
        {
            ...
            half4 ShadowPassFragment(V i):SV_TARGET
            {
                clip(i.positionWS.y - _GroundHeight); 
                return 0;
            }
            ENDHLSL
        }
        ...
        Pass
        {
            ...
            struct V { float4 positionHCS:SV_POSITION; float3 positionWS:TEXCOORD0; };

            V Vert(A i){
                V o;
                VertexPositionInputs v = GetVertexPositionInputs(i.positionOS.xyz);
                o.positionHCS = v.positionCS;
                o.positionWS  = v.positionWS;
                return o;
            }
